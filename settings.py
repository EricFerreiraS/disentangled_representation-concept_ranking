...
MODEL = 'resnet152'                          # model arch: resnet18, alexnet, resnet50, densenet161
...
if MODEL == 'resnet18':
    ...
    FEATURE_NAMES = ['features']
    if DATASET == 'places365':
        MODEL_FILE = 'zoo/whole_alexnet_places365_python36.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = None
        MODEL_PARALLEL = False
    ...
    FEATURE_NAMES = ['layer4']
    if DATASET == 'places365':
        MODEL_FILE = 'zoo/whole_resnet152_places365_python36.pth.tar'
        MODEL_PARALLEL = False
    elif DATASET == 'imagenet':
        MODEL_FILE = None
        MODEL_PARALLEL = False
